...
In this section you will use the `awx.awx` collection to do an end to end configuration of yout *Ansible Tower* server

* Setup your control node to work with Ansible Tower
* Install the `awx.awx` collection
* Use `awx.awx` to fully configure Ansible Tower to deploy the application
